  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          Text(
            masariText(context, 'تخصيص مساري AI', 'MASARI AI Customization'),
            style: MasariTypography.headlineSmall(color: Colors.white),
          ),
          const SizedBox(height: 5),
          Text(
            masariText(
              context,
              'تحكم في شخصية المساعد وسلوكه من مركز المدير. الإعدادات محفوظة محليًا في هذه النسخة التجريبية.',
              'Control the assistant persona and behavior from the admin center. Settings are stored locally in this prototype.',
            ),
          ...
          MasariCard(
            child: Column(
              ...
              children: [
                Text(
                  masariText(context, 'درجة الإبداع', 'Creativity'),
                  style: MasariTypography.titleMedium(color: MasariColors.primaryCyan),
                ),
                const SizedBox(height: 4),
                Text(
                  '${_temperature.toStringAsFixed(2)}  •  ${_temperature < .3 ? masariText(context, 'دقيق', 'Precise') : _temperature > .7 ? masariText(context, 'إبداعي', 'Creative') : masariText(context, 'متوازن', 'Balanced')}',
          ...
          MasariCard(
            child: Column(
              ...
              children: [
                Text(
                  masariText(context, 'تعليمات المساعد الأساسية', 'System instructions'),
                  style: MasariTypography.titleMedium(color: MasariColors.primaryCyan),
                ),
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: masariText(context, 'اكتب قواعد المساعد...', 'Write assistant rules...'),
                  ),
                ),
                const SizedBox(height: 12),
                Align(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    label: Text(masariText(context, 'حفظ التخصيص', 'Save customization')),
                  ),
                ),
              ],
            ),
