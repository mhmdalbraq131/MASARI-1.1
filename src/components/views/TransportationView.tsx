          ...
          >
            <div className="relative h-56 w-full overflow-hidden bg-slate-200 dark:bg-slate-800">
              ...
              <div className="absolute bottom-3 right-3 left-3 flex items-center justify-between text-white text-xs font-semibold">
                <div className="flex items-center gap-3 bg-black/60 backdrop-blur-md px-3 py-1.5 rounded-xl border border-white/10">
            ...
            <div className="p-6 space-y-4 flex-1 flex flex-col justify-between">
              <div>
                <h3 className="text-lg font-extrabold text-[#0B192C] dark:text-white leading-snug">
              ...
              <div className="pt-4 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between">
                ...
                <button
                  ...
                  className="px-6 py-2.5 rounded-xl bg-[#FF6500] hover:bg-[#EA580C] text-white font-extrabold text-xs shadow-md transition-all active:scale-95"
                >
