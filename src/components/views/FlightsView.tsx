...
export const FlightsView: React.FC<FlightsViewProps> = ({ language, onNavigate }) => {
  ...
  return (
    <div className="p-4 md:p-8 space-y-8 max-w-7xl mx-auto w-full transition-colors">
      ...
      <div className="rounded-3xl bg-white dark:bg-[#0A1631] border border-slate-200 dark:border-[#1E293B] p-6 space-y-6 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="w-full h-12 px-4 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 text-xs font-bold text-slate-900 dark:text-white focus:outline-none focus:border-[#00D4FF]"
            />
          </div>
          ...
          <div className="space-y-1.5 flex flex-col justify-end">
            <button className="h-12 w-full rounded-xl bg-[#FF6500] hover:bg-[#EA580C] text-white font-bold text-xs flex items-center justify-center gap-2 shadow-md transition-all">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h2 className="text-lg md:text-xl font-bold text-[#0B192C] dark:text-white">
        ...
        <div className="space-y-4">
          {FLIGHTS_LIST.map((flight) => (
            <div
              key={flight.id}
              className="flex flex-col md:flex-row items-stretch justify-between p-5 rounded-3xl bg-white dark:bg-[#0A1631] border border-slate-200 dark:border-[#1E293B] shadow-sm hover:shadow-md dark:shadow-none hover:border-[#00D4FF]/50 transition-all gap-4"
            >
              {/* Airline & Class Info */}
              <div className="flex items-center gap-4 md:w-1/4">
                <div className="h-12 w-12 rounded-2xl bg-[#00D4FF]/10 text-[#008DDA] dark:text-[#00D4FF] flex items-center justify-center shrink-0">
                  <Plane className="h-6 w-6 stroke-[2]" />
                </div>
                <div>
                  <div className="text-sm font-extrabold text-[#0B192C] dark:text-white">
              ...
              {/* Schedule & Routing */}
              <div className="flex-1 flex items-center justify-around px-4 border-y md:border-y-0 md:border-x border-slate-100 dark:border-slate-800 py-3 md:py-0">
                {/* Departure */}
                ...
                <div className="flex flex-col items-center px-4">
                  ...
                  <div className="relative w-24 md:w-32 my-1 flex items-center justify-center">
              ...
              {/* Baggage & Booking CTA */}
              <div className="flex md:flex-col items-center justify-between md:justify-center md:items-end gap-2 md:w-1/4">
                ...
                <button
                  ...
                  className="px-5 py-2.5 rounded-xl bg-[#FF6500] hover:bg-[#EA580C] text-white font-bold text-xs shadow-md transition-all active:scale-95"
                >
