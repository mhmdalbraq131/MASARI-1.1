...
export const HotelsView: React.FC<HotelsViewProps> = ({ language, onNavigate }) => {
  ...
  return (
    <div className="p-4 md:p-8 space-y-8 max-w-7xl mx-auto w-full transition-colors">
      ...
      {/* Hotel Search Widget */}
      <div className="rounded-3xl bg-white dark:bg-[#0A1631] border border-slate-200 dark:border-[#1E293B] p-6 space-y-4 shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {filteredHotels.map((hotel) => (
          <div
            key={hotel.id}
            className="group flex flex-col md:flex-row rounded-3xl bg-white dark:bg-[#0A1631] border border-slate-200 dark:border-[#1E293B] overflow-hidden shadow-sm hover:shadow-xl dark:shadow-none hover:border-[#00D4FF]/50 transition-all duration-300"
          >
            {/* Image Container */}
            <div className="relative md:w-2/5 h-56 md:h-auto overflow-hidden bg-slate-200 dark:bg-slate-800 shrink-0">
              <img
                src={hotel.image}
              ...
              <div className="absolute top-3 left-3 px-2.5 py-1 rounded-xl bg-[#00D4FF] text-[#050914] text-[11px] font-extrabold shadow-md">
            ...
            <div className="p-5 flex-1 flex flex-col justify-between space-y-3">
              <div>
                <div className="flex items-center gap-1 text-slate-500 text-xs mb-1">
                  <MapPin className="h-3.5 w-3.5 text-[#008DDA] dark:text-[#00D4FF]" />
                ...
                {hotel.distanceToHaramAr && (
                  <div className="mt-1 text-xs font-semibold text-[#008DDA] dark:text-[#00D4FF] bg-[#00D4FF]/10 px-2.5 py-1 rounded-lg inline-block">
